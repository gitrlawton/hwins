...
import { Heart, ChevronDown, ChevronUp, Trophy } from "lucide-react";
      ...
      <div className="p-6">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-grow min-w-0">
            ...
            <p className="text-sm text-muted-foreground leading-snug line-clamp-1 mt-0.5">
              {project.log_line}
            </p>
            <div className="flex items-center text-xs text-muted-foreground mt-0.5">
              <Trophy className="h-3 w-3 mr-1 flex-shrink-0" />
              <span className="truncate">{project.fields_won.join(", ")}</span>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            ...
            <div className="relative">
              <div className="space-y-6 pb-8">
                <div className="grid gap-6 md:gap-14 md:grid-cols-[auto_1fr]">
                  <div>
                    <h4 className="font-medium mb-2">Hackathon</h4>
              ...
              <div className="absolute bottom-0 right-0">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-md text-black-600 hover:underline"
                >
                  Visit
                </a>
              </div>
